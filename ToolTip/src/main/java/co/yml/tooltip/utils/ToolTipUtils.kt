...
/**
 * @function calculatePosition is used to calculate coordinate position from X and Y.
 * */
...
/**
 * @function getStatusBarHeight is used to find Status bar height from resourceId.
 * */
